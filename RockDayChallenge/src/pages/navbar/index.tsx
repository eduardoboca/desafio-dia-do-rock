export function Navbar() {
  return (
    <nav className="float-left pt-9 bg-zinc-950 w-16 h-screen">
      ...
      <a className="flex justify-center items-center h-16 hover:bg-zinc-700" href="https:\\www.google.com.br">
